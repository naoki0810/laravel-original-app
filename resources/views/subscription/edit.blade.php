    ...
    <div class="container pt-4">
        <div class="row justify-content-center">
            <div class="card col-md-8 subscription-form">
                <form action="{{ route('subscription.update') }}" method="post" id="payment-form" class="subscription-form">
                    @csrf
                    @method('PUT')

                    {{-- カード情報 --}}
                    <div class="form-group">
                        <label for="card-holder-name">クレジットカード編集</label>
                        <div>
                            <input id="card-holder-name" class="form-control subscription-form" type="text"
                                placeholder="カード名義人">
                        </div>
                    ...
                    <div id="card-button" class="btn btn-warning mt-5" data-secret="{{ $intent->client_secret }}">編集</div>
                </form>
            </div>
        </div>
    </div>
