...
@section('content')
    <div class="container pt-4">
        ...
        <div class="row justify-content-center">
            <div class="offset-1">
                <div id="map" style="height:500px;" class="col-md-11">
                    <hr>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?language=ja&region=JP&key=AIzaSyBvQqRbDB5sw11t3bL8eGGjNTZa5XodSMs&callback=initMap" async defer>
    </script>
